        ...
        execute: function () {
            NegociacaoController = class NegociacaoController {
                ...
                adiciona(event) {
                    ...
                    const negociacaoNew = new index_2.Negociacao(new Date(this._inputData.val().replace(/-/g, ',')), parseInt(this._inputQuantidade.val()), parseFloat(this._inputValor.val()));
                    this._negociacoes.adiciona(negociacaoNew);
                    this._negociacoesView.update(this._negociacoes);
                    this._mensagemView.update('Negociação adicionada com sucesso');
                    index_5.imprime(negociacaoNew, this._negociacoes);
                }
                _ehDiaUtil(data) {
